...
def carregar_tickers_acoes():
  base_tickers = pd.read_csv(r"C:\Users\Paulo Vitor\Desktop\Cursos\HASHTAG\PYTHON\Streamlit\dashboard ações\IBOV.csv", sep=";")
...
st.write('''
# App Preço de Ações
O gráfico abaixo representa a evolução do preço das ações aos longo dos anos
''') # markdown - tamanho da letra
...
performance_carteira = total_final_carteira / total_inicial_carteira
